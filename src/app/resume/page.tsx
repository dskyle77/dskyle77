...
export default function ResumePage() {
  return (
    <div className="relative">
      <div className="print:hidden"><BackgroundGrid size={{ x: "32px", y: "32px" }} /></div>
      <div className="mx-auto max-w-4xl px-6 py-10 sm:py-16">
        {/* Header actions */}
        <Reveal>
          <div className="flex flex-wrap items-center justify-between gap-4 mb-10 print:hidden border-b border-white/[0.07] pb-6">
